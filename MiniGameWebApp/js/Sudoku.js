...
document.addEventListener('keydown', function(e) {
	...
	switch (e.keyCode) {
	case 37:
		if (document.activeElement.tagName === "INPUT" && document.activeElement.id.startsWith("cell_")) {
			col = col === 0 ? 8 : col - 1;
		} else {
			e.preventDefault();
...
var sudokuBoard = [ "1------45", "--45-17-2", "---2--9--", "-------58",
		"48--57--6", "-3---2---", "---67----", "-51-9-86-", "--6----3-" ];

var answer = [ "128739645", "394561782", "567284913", "712946358", "489357126",
		"635812479", "843675291", "251493867", "976128534" ];
